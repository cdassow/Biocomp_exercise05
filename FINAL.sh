# Part 1: Takes unique gender-yearsExperience combos in wages.csv, sorts
# by gender then number, inputs two columns into new space delimited file. 
# Part 2: Will send the Gender, yearsExperience and wage for highest and
# lowest earner. Then will show number of females in top 10 earners.
# Part 3: The effect of graduating college (12 vs. 16 years education) on
# minimum wages 
